...
![NAT类型分类](../diagrams/output/nat_types.png)
...
![STUN工作原理](../diagrams/output/stun_protocol.png)
...
![TURN中继原理](../diagrams/output/turn_relay.png)
...
![ICE候选收集与检查](../diagrams/output/ice_process.png)
