...
![五大坐标空间变换链](images/coordinate_spaces.png)
...
![Model/View/Projection 矩阵说明](images/mvp_matrices.png)
...
![透视投影 vs 正交投影](images/perspective_vs_ortho.png)
...
![深度测试原理示意](images/depth_buffer.png)
