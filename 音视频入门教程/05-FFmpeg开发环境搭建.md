...
![FFmpeg 六大核心库](images/diagram-05-ffmpeg-libs.png)

它们在播放器中的分工：

![FFmpeg 核心库协作流程](images/diagram-05-ffmpeg-pipeline.png)
...
> **上一篇**：[第 4 章：封装格式与多媒体容器](04-封装格式与多媒体容器.md)
> **下一篇**：[第 6 章：FFmpeg 核心数据结构详解](06-FFmpeg核心数据结构详解.md)
